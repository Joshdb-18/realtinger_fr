...
const TESTIMONIALS = [
  {
    ...
    content: `Incredible platform! Streamlined the entire property buying process for me. Highly recommend!`,
    author: {
      name: 'Clyde Edwards',
      title: 'Homebuyer Extraordinaire',
      avatarUrl: '/testimonials/author-photo-1.jpeg',
    },
  },
  {
    companyLogoUrl: '/testimonials/company-logo-2.svg',
    content: `Effortless transactions! This real estate platform is a game-changer. Smooth, intuitive, and reliable.`,
    author: {
      name: 'Jimmy Hunter',
  ...
  },
  {
    ...
    content: `Top-notch service! Made selling my property a breeze. The features are unmatched, and the process is so user-friendly.`,
    author: {
      name: 'Marjorie Morgan',
      title: 'Property Seller Pro',
